...
import pic2 from './assests/bitcoin1.png'
import pic3 from './assests/litecoin.png'
                        ...
                        <div className="pages">
                            ...
                            <div className="registration form">
                                ...
                                <form action="#">
                                    ...
                                    <input id="sendEmailButton" type="button" className="button" value="Signup" onClick={showOtpScreen} />
                                </form>
                                <div className="signup">
