import pic1 from './assets/logo_only.png';
import pic2 from './assets/logo_text.png';
import pic3 from './assets/jazzcash.png';
import pic4 from './assets/jazz.jpeg';
import pic5 from './assets/img-1.png';
        ...
        <body>
            ...
            <div id="preloader">
                <div className="uptext">
                    <div className="logo"><img src={pic1} alt="" /></div>
                    <div className="logo_text"><img src={pic2} alt="" /></div>
                </div>
                ...
                <div className="main">
                    ...
                    <div className="table">
                        <div className="buysellsection">
                            ...
                            <div className="input-sep">
                                <span className="custom-placeholder"><img className="img" src={pic4} alt="" />
                                    <img className="card" src={pic5} alt="" /></span>
